...
class FeedFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.addAndEdit.observe(this) {
        ...
        viewModel.goToCurrentRecipe.observe(this) { currentRecipe ->
            val direction = FeedFragmentDirections.toCurrentRecipeFragment(currentRecipe.id)
            findNavController().navigate(direction)
        }
    }
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        val text = String.format(resources.getString(R.string.find_recipe))
        ...
        searchView.setOnQueryTextListener(
            ...
            SearchView.OnQueryTextListener {
                override fun onQueryTextSubmit(p0: String?): Boolean {
                    ...
                    val result = viewModel.filterSearch(p0)
